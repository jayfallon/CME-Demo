$(function(){
  ...
  $("#myBuy01, #myBuy02, #mySell01, #mySell02, #expireMessage01, #expireMessage02, li.swapDataListItem a.executeButton, #swapTimer, #buyIndicator, #sellIndicator, #expireMessage").hide();
  ...
  $("#buy01, #sell01").click(function(){
    ...
    $("#swapTimer").oneTime(241000, function(){
      ...
      $("#myBuy01, #myBuy02, #mySell01, #mySell02, li.swapDataListItem a.executeButton, #swapTimer, #sellIndicator, #buyIndicator").fadeOut("slow");
  ...
  $("#buy01").click(function(){
    $("#expireMessage01, #confirmMessage, #expireMessage").fadeOut("fast");
    $("#buy01, #sell01").removeClass("active");
